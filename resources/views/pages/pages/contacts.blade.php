                                            ...
                                            <div class="sm:flex block items-center justify-between">
                                                ...
                                                <div class="flex sm:mt-0 mt-2 items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <button  aria-label="button" type="button" class="ti-btn btn-wave ti-btn-light  !rounded-s-none !mb-0" id="search-contact-member"><i class="ri-search-line text-[#8c9097] dark:text-white/50"></i></button>
                                                    </div>
                                                    <div class="hs-dropdown ti-dropdown ms-2">
                                                        <button  aria-label="button" type="button" class="ti-btn btn-wave ti-btn-icon ti-btn-primary w-[2.313rem] h-[2.313rem]" aria-expanded="false">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <button type="button" class="hs-tooltip-toggle ti-btn btn-wave ti-btn-icon ti-btn-secondary !ms-2 w-[2.313rem] h-[2.313rem]"><i class="ri-add-line"></i>
                                                            <span
                                ...
                                <div class="box">
                                    <div class="box-body contact-action">
                                        ...
                                        <div class="flex items-center justify-center gap-2 contact-hover-buttons">
                                            <button type="button" class="ti-btn btn-wave btn-sm ti-btn-light contact-hover-btn !py-1 !px-2 !text-[0.75rem] !font-medium">
                                                View Contact
                                            </button>
                                            <div class="hs-dropdown ti-dropdwon contact-hover-dropdown">
                                                <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm ti-btn-light" aria-expanded="false">
                                            ...
                                            <button aria-label="button" class="ti-btn btn-wave !py-[0.14rem] !px-2 ti-btn-light contact-hover-dropdown1" type="button">
                                ...
                                <div class="box">
                                    <div class="box-body contact-action">
                                        ...
                                        <div class="flex items-center justify-center gap-2 contact-hover-buttons">
                                            ...
                                            <div class="hs-dropdown ti-dropdwon contact-hover-dropdown">
                                                <button class="ti-btn btn-wave ti-btn-sm ti-btn-light" aria-label="button" type="button" aria-expanded="false">
                                                    <i class="ri-more-2-fill"></i>
                                                </button>
                                                <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                                                    <li><a class="ti-dropdown-item flex !gap-x-0 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="javascript:void(0);"><i class="ri-share-line me-2 align-middle inline-block"></i>Share</a></li>
