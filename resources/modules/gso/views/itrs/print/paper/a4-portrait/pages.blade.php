...
@foreach ($pages as $pageIndex => $page)
    <div class="gso-ptr-print-page">
        @include('gso::itrs.print.partials.header', [
            'report' => $report,
        ...
        <div class="gso-ptr-print-body">
            @include('gso::itrs.print.partials.meta', [
                'report' => $report,
            ])

            @include('gso::itrs.print.partials.table', [
                'rows' => $page['rows'] ?? [],
                'gridRows' => $gridRows,
            ...
            @if ($pageIndex === ($totalPages - 1))
                @include('gso::itrs.print.partials.reason', [
                    'report' => $report,
                ])

                @include('gso::itrs.print.partials.signatures', [
                    'report' => $report,
                ])
            @endif
        </div>

        @include('gso::itrs.print.partials.footer', [
            'pageIndex' => $pageIndex,
