@php
    ...
    $printable = $printConfig->printable('gso_ris');
    $ris = $report['ris'] ?? [];
    ...
    $paperDefaults = collect($allowedPapers)
        ...
        ->all();
    $currentRowsPerPage = (int) ($filters['rows_per_page'] ?? ($paperProfile['rows_per_page'] ?? 24));
    $currentGridRows = (int) ($filters['grid_rows'] ?? ($paperProfile['grid_rows'] ?? 24));
...
>
    <div class="core-print-sidebar">
        ...
        <form
            method="GET"
            action="{{ route('gso.ris.print', ['ris' => $ris['id'] ?? '']) }}"
            class="core-print-sidebar__form"
            data-ris-print-form="1"
            data-ris-print-paper-defaults='@json($paperDefaults)'
        >
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-ris-print-setting="rows_per_page"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-ris-print-setting="grid_rows"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-ris-print-setting="last_page_grid_rows"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-ris-print-setting="description_chars_per_line"
                        >
                    </div>
                </div>

                <button type="button" class="core-print-sidebar__link-button" data-ris-print-apply-defaults="1">
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__stats">
                    ...
                    <div class="core-print-sidebar__stat">
                        <span class="core-print-sidebar__stat-label">Total Requested</span>
                        <strong class="core-print-sidebar__stat-value">{{ number_format((int) ($summary['qty_requested_total'] ?? 0)) }}</strong>
                    </div>

                    <div class="core-print-sidebar__stat">
                        <span class="core-print-sidebar__stat-label">Total Issued</span>
                        <strong class="core-print-sidebar__stat-value">{{ number_format((int) ($summary['qty_issued_total'] ?? 0)) }}</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="core-print-sidebar__section core-print-sidebar__section--actions">
                ...
                <div class="core-print-sidebar__actions">
                    ...
                    <a
                        ...
                        data-ris-print-pdf-base="{{ route('gso.ris.print.pdf', ['ris' => $ris['id'] ?? '']) }}"
                    ...
                    @include('gso::print.partials.archive-action', [
                        ...
                        'uploadPermission' => 'ris.upload_signed_pdf',
