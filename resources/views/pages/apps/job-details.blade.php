...
@section('content')
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Job Details</h3>
                            </div>
                                    ...
                                    <div class="sm:flex align-top justify-between">
                                        ...
                                        <div>
                                            <div class="btn-list sm:flex items-center mb-2">
                                                <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-primary-full m-0 !me-[0.375rem]"> Apply Now</a>
                                                <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-primary me-[0.375rem]">
                                        ...
                                        <div class="box-body">
                                            <div class="grid grid-cols-12 items-center">
                                                ...
                                                <div class="lg:col-span-6 col-span-12 text-end">
                                                    <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-success-full ti-btn-lg dark:!border-defaultborder/10">
                                        ...
                                        <div class="box-body !p-0">
                                            <ul class="list-group  list-group-flush">
                                                <li class="list-group-item !border-t-0 !border-s-0 !border-e-0 mb-2">
                                                    <div class="sm:flex">
                                                        <span class="avatar avatar-md !rounded-full bg-primary/10 !fill-primary border dark:border-defaultborder/10">
                                    ...
                                    <div class="box custom-box border dark:border-defaultborder/10">
                                        ...
                                        <div class="box-body !p-0">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item !border-t-0 !border-s-0 !border-e-0 mb-2">
                                                    <div class="flex">
                                                        <span class="avatar avatar-md !rounded-full bg-gray-200 border dark:border-defaultborder/10">
                                        ...
                                        <div class="box-body">
                                            <div class="">
                                                ...
                                                <label class="form-check-label">
                                                    By Subscribing you accept to <a href="javascript:void(0);" class="text-success ms-1"><u>privacy policy</u></a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
