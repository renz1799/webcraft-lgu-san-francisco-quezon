...
<div class="block justify-between page-header md:flex">
  <div>
    ...
    <p class="text-[#8c9097] text-sm mt-1">Track active work, archived records, and claimable queues from one page.</p>
  </div>
      ...
      <div class="box-header">
        <div class="tasks-header">
          <div>
            ...
            <p class="text-[#8c9097] text-xs mt-1">The working task table stays intact. The right panel adapts by role.</p>
          </div>
