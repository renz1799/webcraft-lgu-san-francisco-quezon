                    ...
                    <div class="grid grid-cols-12 gap-x-6 mb-[3rem]">
                        ...
                        <div class="xl:col-span-12 col-span-12">
                            <div class="tab-content" id="myTabContent1">
                                                ...
                                                <div class="box-body !p-0">
                                                    ...
                                                    <div class="!p-6">
                                                        ...
                                                        <ul class="list-none mb-0">
                                                            ...
                                                            <li class="grid">
                                                                <button type="button" class="ti-btn btn-wave bg-primary text-white">Choose Plan</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="!p-6">
                                                        ...
                                                        <ul class="list-none mb-0">
                                                            <li class="flex items-center mb-4">
                                                                ...
                                                                <span>
                                                                    <strong class="me-1">20 Free</strong>Websites
                                                                </span>
                                                            </li>
                                                            <li class="flex items-center mb-4">
                                                                <span class="me-2">
                                                                ...
                                                                <span>
                                                                    <strong class="me-1">30 GB</strong>Hard disk storage
                                                                </span>
                                                            </li>
                                                            <li class="flex items-center mb-4">
                                                                <span class="me-2">
                                                                ...
                                                                <span>
                                                                    <strong class="me-1">5 Year</strong>Email support
                                                                </span>
                                                            </li>
                                                            <li class="flex items-center mb-4">
                                                                <span class="me-2">
                                                                ...
                                                                <span>
                                                                    <strong class="me-1">50</strong>Licenses
                                                                </span>
                                                            </li>
                                                            <li class="flex items-center mb-4">
                                                                <span class="me-2">
                                ...
                                <div class="tab-pane !p-0 !border-0 hidden" id="pricing-yearly1-pane" role="tabpanel" >
                                    <div class="grid grid-cols-12 gap-6">
                                        <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            <div class="box overflow-hidden">
                                                <div class="box-body !p-0">
                                                ...
                                                <div class="grid grid-cols-12">
                                                    <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12 md:border-e md:border-b-0 border-b border-dashed dark:border-defaultborder/10 pe-0">
                                                        <div class="p-6">
                                                            ...
                                                            <div class="grid">
                                                                <button type="button" class="ti-btn btn-wave ti-btn-primary">Get Started</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12 ps-0">
                                                        <div class="p-6 pricing-offer overflow-hidden">
                                                            ...
                                                            <div class="grid">
                                                                <button type="button" class="ti-btn btn-wave bg-primary text-white">Get Started</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <table class="table table-bordered dark:border-defaultborder/10 whitespace-nowrap min-w-full">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border border-defaultborder dark:border-defaultborder/10">
                                                        ...
                                                        <td>
                                                            <span
                                                                ...
                                                                <i class="ri-close-line align-middle font-semibold"></i>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <span
                                                    ...
                                                    <tr class="border border-defaultborder dark:border-defaultborder/10">
                                                        ...
                                                        <td class="border-b-0">
                                                            <button type="button" class="ti-btn btn-wave bg-primary text-white">Choose
                                                                Plan</button>
                                                        </td>
                                                        <td class="border-b-0">
                                                            <button type="button" class="ti-btn btn-wave bg-primary text-white">Choose
