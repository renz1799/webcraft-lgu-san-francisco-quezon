@php
    ...
    $printable = $printConfig->printable('gso_wmr');
    $wmr = $report['wmr'] ?? [];
    $document = $report['document'] ?? [];
    $summary = $document['summary'] ?? [];
    $pagination = $report['pagination']['stats'] ?? [];
    $selectedPaper = $filters['paper_profile'] ?? ($paperProfile['code'] ?? $printConfig->defaultPaper('gso_wmr', 'a4-portrait'));
    $allowedPapers = $printConfig->allowedPapers('gso_wmr', 'a4-portrait');
    ...
    $paperDefaults = collect($allowedPapers)
        ...
        ->all();
    $currentRowsPerPage = (int) ($filters['rows_per_page'] ?? ($paperProfile['rows_per_page'] ?? 10));
    $currentGridRows = (int) ($filters['grid_rows'] ?? ($paperProfile['grid_rows'] ?? 10));
    $currentLastPageGridRows = (int) ($filters['last_page_grid_rows'] ?? ($paperProfile['last_page_grid_rows'] ?? 10));
    $currentDescriptionCharsPerLine = (int) ($filters['description_chars_per_line'] ?? ($paperProfile['description_chars_per_line'] ?? 34));
    $layoutHelp = [
        ...
        'last_page_grid_rows' => 'Target grid height for the last page before the signatory and inspection blocks; blank rows are added until it is reached.',
...
<x-print.panel
    ...
    copy="Choose the paper profile, review the WMR preview on the right, then print or download the PDF."
>
    <div class="core-print-sidebar">
        ...
        <form
            method="GET"
            action="{{ route('gso.wmrs.print', ['wmr' => $wmr['id'] ?? '']) }}"
            class="core-print-sidebar__form"
            data-wmr-print-form="1"
            data-wmr-print-paper-defaults='@json($paperDefaults)'
        >
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="1" max="200" name="rows_per_page" value="{{ $currentRowsPerPage }}" class="form-control" data-wmr-print-setting="rows_per_page">
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="1" max="200" name="grid_rows" value="{{ $currentGridRows }}" class="form-control" data-wmr-print-setting="grid_rows">
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="0" max="200" name="last_page_grid_rows" value="{{ $currentLastPageGridRows }}" class="form-control" data-wmr-print-setting="last_page_grid_rows">
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="10" max="300" name="description_chars_per_line" value="{{ $currentDescriptionCharsPerLine }}" class="form-control" data-wmr-print-setting="description_chars_per_line">
                    </div>
                </div>

                <button type="button" class="core-print-sidebar__link-button" data-wmr-print-apply-defaults="1">
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__stats">
                    ...
                    <div class="core-print-sidebar__stat">
                        <span class="core-print-sidebar__stat-label">Disposal Lines</span>
            ...
            <div class="core-print-sidebar__section core-print-sidebar__section--actions">
                ...
                <div class="core-print-sidebar__actions">
                    ...
                    <a
                        href="{{ route('gso.wmrs.print.pdf', ['wmr' => $wmr['id'] ?? ''] + $pdfParams) }}"
                        data-wmr-print-pdf-download="1"
                        data-wmr-print-pdf-base="{{ route('gso.wmrs.print.pdf', ['wmr' => $wmr['id'] ?? '']) }}"
