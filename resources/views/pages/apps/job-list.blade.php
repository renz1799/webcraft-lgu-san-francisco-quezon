                                ...
                                <div class="box  overflow-hidden">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <a href="{{url('job-post')}}" class="ti-btn btn-wave ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]">
                                            ...
                                            <table class="table table-hover whitespace-nowrap min-w-full">
                                                ...
                                                <tbody>
                                                    <tr class="border-t hover:bg-gray-200 dark:hover:bg-light">
                                                        ...
                                                        <td>
                                                            <a aria-label="anchor" href="{{url('job-details')}}" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-primary">
                                                                <i class="ri-eye-line"></i>
                                                            </a>
                                                            <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-info">
                                                                <i class="ri-edit-line"></i>
                                                            </a>
                                                            <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-danger">
