...
@php
    ...
    $pdfPreviewUrl = route('gso.ics.print.pdf', array_merge(['ics' => $ics['id'] ?? ''], $filters ?? [], ['inline' => 1]))
...
@section('content')
    ...
    >
        <x-slot:sidebar>
            @include('gso::ics.print.partials.controls', [
                'report' => $report,
...
@push('scripts')
    @vite('resources/modules/gso/js/ics/print.js')
@endpush
