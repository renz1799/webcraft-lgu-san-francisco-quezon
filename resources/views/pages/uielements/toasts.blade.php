                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <div class="ti-toast bg-purplemain text-sm text-white" role="alert">
                                            <div class="flex p-4">
                                                Hello, world! This is a toast message.
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <div class="ti-toast bg-purplemain/10 text-sm text-purplemain" role="alert">
                                            <div class="flex p-4">
                                                Hello, world! This is a toast message.

                                                <div class="ms-auto">
                                                    <button type="button"
                                                        class="inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-sm text-purplemain  focus:outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-indigo-800 focus:ring-indigo-500 transition-all text-sm dark:focus:ring-offset-indigo-500 dark:focus:ring-indigo-700">
                                                        <span class="sr-only">Close</span>
                                                        <svg class="w-3.5 h-3.5" width="16" height="16"
                                                            viewBox="0 0 16 16" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
