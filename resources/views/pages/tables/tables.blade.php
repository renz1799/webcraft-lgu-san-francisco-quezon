                                    ...
                                    <table class="table whitespace-nowrap ti-striped-table min-w-full">
                                        ...
                                        <tbody>
                                            <tr  class="border-b border-defaultborder ">
                                                ...
                                                <td>Moracco</td>
                                                <td>
                                                    <button type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-success-full btn-wave">
                                            ...
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>Erica Sean</td>
                                                <td>
                                                    <button aria-label="button" type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-success-full btn-wave">
                                                        <i class="ri-download-2-line align-middle me-2 inline-block"></i>Download
                                                    </button>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table whitespace-nowrap table-striped-columns min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>Moracco</td>
                                                <td>
                                                    <button aria-label="button" type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-danger-full btn-wave">
                                    ...
                                    <table class="table whitespace-nowrap table-hover min-w-full ti-custom-table-hover">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-defaultborder ">
                                                ...
                                                <td>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary w-[52%]" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder ">
                                                ...
                                                <td>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary w-2/5" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder ">
                                                ...
                                                <td>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary w-[17%]" >
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table whitespace-nowrap min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>24 May 2022</td>
                                                <td>
                                                    <button type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-primary">Pending</button>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder">
                                                <th scope="row" class="text-start">Zozo Hadid</th>
                                            ...
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>15 April 2022</td>
                                                <td>
                                                    <button type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-danger">Rejected</button>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder">
                                                <th scope="row" class="text-start">Alex Carey</th>
                                                ...
                                                <td>17 March 2022</td>
                                                <td>
                                                    <button type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-success">Processed</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table whitespace-nowrap table-sm min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-light"><i class="ri-download-2-line"></i></a>
                                                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-light"><i class="ri-edit-line"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder">
                                    ...
                                    <table class="table whitespace-nowrap min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-success-full"><i class="ri-download-2-line"></i></a>
                                                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-info-full"><i class="ri-edit-line"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary w-[91%]" >
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$1.4billion</td>
                                            ...
                                            <tr class="border-b border-defaultborder">
                                                ...
                                                <td>
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary w-[45%]" >
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$7,123.21</td>
