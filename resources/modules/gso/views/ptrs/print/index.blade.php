...
@php
    ...
    $pdfPreviewUrl = route('gso.ptrs.print.pdf', array_merge(['ptr' => $ptr['id'] ?? ''], $filters ?? [], ['inline' => 1]))
...
@section('content')
    ...
    >
        <x-slot:sidebar>
            @include('gso::ptrs.print.partials.controls', [
                'report' => $report,
...
@push('scripts')
    @vite('resources/modules/gso/js/ptrs/print.js')
@endpush
