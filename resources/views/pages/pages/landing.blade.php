...
@section('content')
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="xxl:col-span-7 xl:col-span-7 lg:col-span-7 col-span-12">
                                        <div class="lg:py-[3rem]">
                                            <div class="mb-4">
                                                <h5 class="font-semibold text-white opacity-[0.9] text-[1.25rem]">BRILLIANCE IN EXECUTION</h5>
                                            </div>
                                            ...
                                            <a href="{{url('index')}}" class="m-1 ti-btn btn-wave ti-btn-primary-full">
                                                View Demos
                    ...
                    <section class="section  bg-[#f9fafb] section-bg text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="team">
                        <div class="container text-center">
                            ...
                            <div class="mt-[3rem]">
                                <button type="button" class="ti-btn btn-wave bg-primary text-white">View All</button>
                            </div>
                        </div>
                    </section>
                    <!-- End:: Section-7 -->
                                            ...
                                            <div class="grid grid-cols-12 justify-center">
                                                <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12  md:border-e md:border-b-0 border-b border-dashed dark:border-defaultborder/10">
                                                    <div class="p-6">
                                                        ...
                                                        <div class="grid">
                                                            <button type="button" class="ti-btn btn-wave ti-btn-primary !font-medium">Get Started</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12  md:border-e md:border-b-0 border-b border-dashed dark:border-defaultborder/10">
                                                ...
                                                <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12">
                                                    <div class="p-6 pricing-offer overflow-hidden">
                                                        ...
                                                        <div class="grid">
                                                            <button type="button" class="ti-btn btn-wave bg-primary text-white !font-medium shadow">Get Started</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-12 gap-4 mt-2 px-4">
                                                ...
                                                <div class="xl:col-span-12 col-span-12">
                                                    <div class="flex  mt-6 ">
                                                        <div class="">
                                                            <div class="btn-list">
                                                                <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-icon ti-btn-primary me-[0.375rem]">
                                                                    <i class="ri-facebook-line font-bold"></i>
                                                                </button>
                                                                <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-icon ti-btn-primary me-[0.375rem]">
                                                                    <i class="ri-twitter-x-line font-bold"></i>
                                                                </button>
                                                                <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-icon ti-btn-primary">
                                                                    <i class="ri-instagram-line font-bold"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <button type="button" class="ti-btn btn-wave bg-primary  text-white !font-medium">Send Message</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="px-6">
                                        ...
                                        <ul class="list-unstyled font-normal landing-footer-list">
                                            ...
                                            <li class="mt-4 !mb-0">
                                                ...
                                                <div class="mb-0">
                                                    <div class="btn-list">
                                                        <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm !mb-0 ti-btn-primary me-[0.365rem]">
                                                            <i class="ri-facebook-line font-bold"></i>
                                                        </button>
                                                        <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm !mb-0 ti-btn-secondary me-[0.365rem]">
                                                            <i class="ri-twitter-x-line font-bold"></i>
                                                        </button>
                                                        <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm !mb-0 ti-btn-warning me-[0.365rem]">
                                                            <i class="ri-instagram-line font-bold"></i>
                                                        </button>
                                                        <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm !mb-0 ti-btn-success me-[0.365rem]">
                                                            <i class="ri-github-line font-bold"></i>
                                                        </button>
                                                        <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm !mb-0 ti-btn-danger">
