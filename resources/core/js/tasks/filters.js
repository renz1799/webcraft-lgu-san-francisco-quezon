(function () {
  ...
  onReady(function () {
    ...
    const module = document.getElementById("tasks-module");
    ...
    const defaultModule = (module?.value || "").trim();
    ...
    function syncFromUI() {
      ...
      filters.module_id = (module?.value || defaultModule).trim();
    ...
    function countAdvanced() {
      ...
      if ((module?.value || defaultModule).trim() !== defaultModule) n++;
    ...
    advReset?.addEventListener("click", (e) => {
      ...
      if (module) module.value = defaultModule;
