@php
    ...
    $printable = $printConfig->printable('gso_itr');
    $itr = $report['itr'] ?? [];
    $document = $report['document'] ?? [];
    $summary = $document['summary'] ?? [];
    $pagination = $report['pagination']['stats'] ?? [];
    $selectedPaper = $filters['paper_profile'] ?? ($paperProfile['code'] ?? $printConfig->defaultPaper('gso_itr', 'a4-portrait'));
    $allowedPapers = $printConfig->allowedPapers('gso_itr', 'a4-portrait');
...
<x-print.panel
    ...
    copy="Choose the paper profile, review the ITR preview on the right, then print or download the PDF."
>
    <div class="core-print-sidebar">
        ...
        <form
            method="GET"
            action="{{ route('gso.itrs.print', ['itr' => $itr['id'] ?? '']) }}"
            class="core-print-sidebar__form"
            data-itr-print-form="1"
            data-itr-print-paper-defaults='@json($paperDefaults)'
        >
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-itr-print-setting="rows_per_page"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-itr-print-setting="grid_rows"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-itr-print-setting="last_page_grid_rows"
                        >
                    </div>
                    ...
                    <div class="core-print-sidebar__field">
                        ...
                        <input
                            ...
                            class="form-control"
                            data-itr-print-setting="description_chars_per_line"
                        >
                    </div>
                </div>

                <button type="button" class="core-print-sidebar__link-button" data-itr-print-apply-defaults="1">
            ...
            <div class="core-print-sidebar__section core-print-sidebar__section--actions">
                ...
                <div class="core-print-sidebar__actions">
                    ...
                    <a
                        href="{{ route('gso.itrs.print.pdf', ['itr' => $itr['id'] ?? ''] + $pdfParams) }}"
                        data-itr-print-pdf-download="1"
                        data-itr-print-pdf-base="{{ route('gso.itrs.print.pdf', ['itr' => $itr['id'] ?? '']) }}"
                    ...
                    @include('gso::print.partials.archive-action', [
                        ...
                        'uploadPermission' => 'itr.upload_signed_pdf',
