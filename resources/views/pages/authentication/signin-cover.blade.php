  ...
  <div class="grid grid-cols-12 items-center h-full ">
    ...
    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
      <div class="p-[3rem]">
        ...
        <p class="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal">Welcome back Jhon !</p>
        <div class="btn-list">
          ...
          <button aria-label="button" type="button" class="ti-btn ti-btn-icon ti-btn-info"><i class="ri-twitter-x-fill"></i></button>
        </div>
        ...
        <div class="grid grid-cols-12">
            ...
            <div class="xl:col-span-12 col-span-12 mb-4">
                <label for="signin-password" class="form-label text-default block">Password<a href="{{url('resetpassword-cover')}}" class="ltr:float-right rtl:float-left text-danger">Forget password ?</a></label>
                <div class="input-group">
                    <input type="password" class="form-control form-control-lg !border-s border-defaultborder dark:border-defaultborder/10 !rounded-e-none" id="signin-password" placeholder="password">
            ...
            <div class="xl:col-span-12 col-span-12 grid">
                <a href="{{url('index')}}" class="ti-btn ti-btn-lg bg-primary text-white  btn-wave !font-medium dark:border-defaultborder/10">Sign In</a>
            </div>
        </div>
        <div class="text-center">
            <p class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Dont have an account? <a href="{{url('signup-cover')}}" class="text-primary">Sign Up</a></p>
        </div>
      </div>
    </div>
    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
