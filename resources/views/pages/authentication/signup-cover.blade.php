          ...
          <div class="flex justify-center items-center h-full">
            <div class="p-[3rem]">
                ...
                <div class="btn-list">
                    ...
                    <button aria-label="button" type="button" class="ti-btn ti-btn-icon ti-btn-light"><i class="ri-twitter-x-fill"></i></button>
                </div>
                ...
                <div class="grid grid-cols-12 ">
                    ...
                    <div class="xl:col-span-12 col-span-12 mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg w-full !rounded-md" id="signup-lastname" placeholder="last name">
                    </div>
                    <div class="xl:col-span-12 col-span-12 mb-4">
                        <label for="signup-password" class="form-label text-default">Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control form-control-lg !border-s border-defaultborder dark:border-defaultborder/10 !rounded-e-none" id="signup-password" placeholder="password">
                    ...
                    <div class="xl:col-span-12 col-span-12 mb-4">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control !border-s border-defaultborder dark:border-defaultborder/10 form-control-lg !rounded-e-none" id="signup-confirmpassword" placeholder="confirm password">
                        ...
                        <div class="form-check mt-4 flex !ps-0 ">
                            ...
                            <label class="form-check-label text-[#8c9097] dark:text-white/50 font-normal inline" for="defaultCheck1">
                                By creating a account you agree to our <a href="{{url('terms')}}" class="text-success"><u>&nbsp;Terms &amp; Conditions</u></a>&nbsp; and&nbsp; <a class="text-success"><u>Privacy Policy</u></a>
                            </label>
                        </div>
                    </div>
                    <div class="xl:col-span-12 col-span-12 grid ">
                        <button type="button" class="ti-btn ti-btn-lg bg-primary text-white  btn-wave !font-medium dark:border-defaultborder/10">Create Account</button>
                    </div>
                </div>
