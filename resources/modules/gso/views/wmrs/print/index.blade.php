...
@php
    ...
    $pdfPreviewUrl = route('gso.wmrs.print.pdf', array_merge(['wmr' => $wmr['id'] ?? ''], $filters ?? [], ['inline' => 1]))
        . '#' . $pdfPreviewFragment;
@endphp
...
@section('content')
    ...
    >
        <x-slot:sidebar>
            @include('gso::wmrs.print.partials.controls', [
                'report' => $report,
...
@push('scripts')
    @vite('resources/modules/gso/js/wmrs/print.js')
@endpush
