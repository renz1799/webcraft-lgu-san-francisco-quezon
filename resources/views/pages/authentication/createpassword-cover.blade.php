              ...
              <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                <div class="p-[3rem]">
                  ...
                  <div class="btn-list">
                    ...
                    <button aria-label="button" type="button" class="ti-btn ti-btn-icon ti-btn-primary  btn-wave me-[0.365rem]"><i class="ri-facebook-fill"></i></button>
                    <button aria-label="button" type="button" class="ti-btn ti-btn-icon ti-btn-info  btn-wave"><i class="ri-twitter-x-fill"></i></button>
                  </div>
                  ...
                  <div class="grid grid-cols-12 gap-y-4">
                    ...
                    <div class="xl:col-span-12 col-span-12">
                      ...
                      <div class="flex">
                        <input type="password"
                          class="form-control form-control-lg !border-s border-defaultborder dark:border-defaultborder/10 !w-full !rounded-e-none"
                      ...
                      <div class="mt-2">
                        <div class="form-check !ps-0">
                          <input class="form-check-input !border-s border-defaultborder dark:border-defaultborder/10" type="checkbox" value="" id="defaultCheck1">
                    ...
                    <div class="xl:col-span-12 col-span-12 grid mt-2">
                      <a href="{{url('index')}}" type="button" class="ti-btn ti-btn-lg bg-primary text-white  btn-wave !font-medium dark:border-defaultborder/10">Save
                        Password</a>
                    </div>
                  </div>
