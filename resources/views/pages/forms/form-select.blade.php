...
@section('content')
                ...
                <div class="block justify-between page-header md:flex">
                    <div>
                        <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Form Select</h3>
                    </div>
                  ...
                  <div class="col-span-12 md:col-span-6 xl:!col-span-4">
                    <div class="box">
                      ...
                      <div class="box-body !pt-0">
                        <label for="hs-select-label" class="ti-form-select rounded-sm !py-2 !px-0 label">Label</label>
                    ...
                    <div class="box">
                      ...
                      <div class="box-body">
                        <div class="space-y-3">
                          ...
                          <select class="ti-form-select rounded-sm sm:!p-4">
                            <option selected>Open this select menu</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                          ...
                          <select class="ti-form-select rounded-sm sm:!p-5">
                            <option selected>Open this select menu</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                      ...
                      <div class="box-body !pt-0">
                        <div class="space-y-3">
                          <div>
                            ...
                            <div class="relative">
                              <select id="select-1" class="ti-form-select rounded-sm !py-2 !px-3 pe-16 !border-red focus:border-red focus:ring-red">
                                <option selected>Open this select menu</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                          ...
                          <div>
                            <label for="select-2" class="ti-form-select rounded-sm !py-2 !px-0 label">Label</label>
                            <div class="relative">
                              <select id="select-2" class="ti-form-select rounded-sm !py-2 !px-3 pe-16 !border-green focus:border-green focus:ring-green">
                ...
                <div class="grid grid-cols-12 gap-x-6">
                  ...
                  <div class="col-span-12  md:col-span-6 xl:!col-span-3">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <select class="ti-form-select rounded-sm !p-0" id="select-beast" autocomplete="off">
                  ...
                  <div class="col-span-12  md:col-span-6 xl:!col-span-3">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <select class="ti-form-select rounded-sm !p-0" id="select-beast-disabled" autocomplete="off" disabled>
                          <option value="">Select a person...</option>
                          <option value="4">Thomas Edison</option>
                          <option value="1">Nikola</option>
                  ...
                  <div class="col-span-12  md:col-span-6 xl:!col-span-3">
                    <div class="box">
                      ...
                      <div class="box-body">
                        <select class="ti-form-select rounded-sm !p-0"  id="select-state" name="state[]" multiple autocomplete="off">
                ...
                <div class="grid grid-cols-12 gap-x-6">
                  <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                      ...
                      <div class="box-body !pt-0">
                        <label class="ti-form-select rounded-sm !py-2 !px-0 label">Default Choices Select</label>
                        ...
                        <label class="ti-form-select rounded-sm !py-2 !px-0 label">With Remove Button</label>
                        ...
                        <label class="ti-form-select rounded-sm !py-2 !px-0 label">Option groups</label>
                  ...
                  <div class="col-span-12 lg:col-span-6">
                    <div class="box">
                      ...
                      <div class="box-body !pt-0">
                        <label class="ti-form-select rounded-sm !py-2 !px-0 label">Default Single Choices Select</label>
