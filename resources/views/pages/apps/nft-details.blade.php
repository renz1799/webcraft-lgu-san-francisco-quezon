...
@section('content')
                        ...
                        <div class="container">
                            ...
                            <div class="box custom-box overflow-hidden">
                                <div class="box-body">
                                    <span class="nft-details-auction-time shadow rtl:rotate-[315deg]">24hrs : 32mins : 11sec</span>
                                    <div class="grid grid-cols-12 md:gap-x-[3rem]">
                                        <div class="xl:col-span-4 col-span-12">
                                                <div class="md:mb-[3rem] mb-4">
                                                    <div class="swiper swiper-preview-details bg-light product-details-page dirrtl">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide" id="img-container">
                                                                <img class="img-fluid !rounded-md" src="{{asset('build/assets/images/nft-images/32.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid !rounded-md" src="{{asset('build/assets/images/nft-images/31.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid !rounded-md" src="{{asset('build/assets/images/nft-images/30.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid !rounded-md" src="{{asset('build/assets/images/nft-images/33.png')}}" alt="img">
                                                            </div>
                                                        </div>
                                                        <div class="swiper-button-next"></div>
                                                        <div class="swiper-button-prev"></div>
                                                    </div>
                                                    <div class="swiper swiper-view-details switcher-nft-details mt-2">
                                                        <div class="swiper-wrapper">
                                                    ...
                                                    <div class="grid mt-4">
                                                        <button type="button" class="ti-btn  btn-wave ti-btn-primary-full btn-wave">Place a bid</button>
                                                    </div>
                                                </div>
                                            <div class="md:block hidden">
                                                <p class="text-[.9375rem] font-semibold mb-2">Featured NFT's :</p>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered whitespace-nowrap min-w-full">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="grid">
                                                                    <button type="button" class="ti-btn btn-wave ti-btn-primary">View All NFT's</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="xxl:mt-0 mt-4">
                                                ...
                                                <div class="grid grid-cols-12 mb-6">
                                                    <div class="xxl:col-span-3 xl:col-span-12 col-span-12">
                                                        ...
                                                        <p class="mb-1"><span class="h3"><span class="avatar avatar-sm avatar-rounded p-1 bg-light"><img src="{{asset('build/assets/images/crypto-currencies/regular/Ethereum.svg')}}" alt=""></span>1.299<sup class="text-[0.875rem]">.00</sup></span><span class="ms-3 badge bg-danger/10 text-danger">50% Off</span></p>
                                                    ...
                                                    <div class="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12  col-span-12 xxl:mt-0 mt-4">
                                                        ...
                                                        <div class="flex items-center font-semibold">
                                                            <span class="avatar avatar-xs avatar-rounded leading-none me-1"><img src="{{asset('build/assets/images/faces/9.jpg')}}" alt=""></span>
                                                            Json Taylor
                                                        </div>
                                                    </div>
                                                    <div class="xxl:col-span-5 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 xxl:mt-0 mt-4">
                                                        <p class="mb-2 text-[.9375rem] font-semibold">Published</p>
                                                        <span class="block font-semibold">24, Jul 2023 - 12:45PM</span>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <div class="grid grid-cols-12 sm:gap-x-6 justify-center">
                                                        <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                                                            <div class="ecommerce-assurance">
                                                                ...
                                                                <p class="text-[0.875rem] font-semibold mb-0">Featured NFT</p>
                                                            </div>
                                                        </div>
                                                        <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12 sm:mt-0 mt-4">
                                                            <div class="ecommerce-assurance">
                                                                <p class="mb-4 !inline-flex">
                                                    ...
                                                    <div class="grid grid-cols-12 sm:gap-6">
                                                        <div class="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                <div class="text-[0.75rem] me-2 font-semibold">5</div>
                                                                <i class="ri-star-fill text-[0.625rem] me-1"></i>
                                                                <div class="progress progress-xs flex-grow">
                                                                    <div class="progress-bar !bg-success !text-white w-[55%]" >
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                ...
                                                                <i class="ri-star-fill text-[0.625rem] me-1"></i>
                                                                <div class="progress progress-xs flex-grow">
                                                                    <div class="progress-bar !bg-success !text-white w-[22%]" >
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                ...
                                                                <i class="ri-star-fill text-[0.625rem] me-1"></i>
                                                                <div class="progress progress-xs flex-grow">
                                                                    <div class="progress-bar !bg-success !text-white w-[8%]" >
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                ...
                                                                <i class="ri-star-fill text-[0.625rem] me-1"></i>
                                                                <div class="progress progress-xs flex-grow">
                                                                    <div class="progress-bar !bg-warning w-[9%]" >
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <i class="ri-star-fill text-[0.625rem] me-1"></i>
                                                                <div class="progress progress-xs flex-grow">
                                                                    <div class="progress-bar !bg-danger w-[6%]" >
                                                                    </div>
                                                                </div>
                                                                <div class="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(1)</div>
                                                            </div>
                                                        ...
                                                        <div class="xxl:col-span-8 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12 xxl:mt-0 mt-4">
                                                            <div class="border dark:border-defaultborder/10 p-4">
                                                                ...
                                                                <div class="product-images sm:!ps-4 !ps-0">
                                                                    <div class="grid grid-cols-12 sm:gap-6">
                                                                        <div class="xl:col-span-6 col-span-12">
                                                                            <div class="products-review-images flex space-x-2 rtl:space-x-reverse">
                                                                        ...
                                                                        <div class="xl:col-span-6 col-span-12 flex items-end sm:justify-end sm:mt-0 mt-2 flex-wrap">
                                                                            <button type="button" class="ti-btn btn-wave !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2">Report abuse</button>
                                                                            <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm ti-btn-primary me-2">
                                                                                <i class="ri-thumb-up-line"></i>
                                                                            </button>
                                                                            <button aria-label="button" type="button" class="ti-btn btn-wave ti-btn-sm ti-btn-primary">
