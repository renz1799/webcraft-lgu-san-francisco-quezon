@php
    ...
    $printable = $printConfig->printable('gso_rpcppe');
    $document = $report['document'] ?? [];
    $summary = $document['summary'] ?? [];
    $signatories = $document['signatories'] ?? [];
    $pagination = $report['pagination']['stats'] ?? [];
    $selectedPaper = $filters['paper_profile'] ?? ($paperProfile['code'] ?? $printConfig->defaultPaper('gso_rpcppe', 'a4-landscape'));
    $allowedPapers = $printConfig->allowedPapers('gso_rpcppe', 'a4-landscape');
...
<x-print.panel kicker="RPCPPE" title="Physical Count of PPE" copy="Keep the required RPCPPE report filters and signatories here, then tune the landscape preview on the right.">
    <div class="core-print-sidebar">
        <div class="core-print-sidebar__intro">
            ...
            <p class="core-print-sidebar__help">RPCPPE keeps its required scope filters in the panel while following the shared print workspace flow.</p>
        </div>

        <form method="GET" action="{{ route('gso.reports.rpcppe.print') }}" class="core-print-sidebar__form" data-rpcppe-print-form="1" data-rpcppe-print-paper-defaults='@json($paperDefaults)' data-rpcppe-print-accountable-suggest-url="{{ route('gso.accountable-persons.suggest') }}">
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__field">
                    ...
                    <select name="paper_profile" class="form-control" data-rpcppe-print-paper-select="1">
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="1" max="200" name="rows_per_page" value="{{ $currentRowsPerPage }}" class="form-control" data-rpcppe-print-setting="rows_per_page">
                    </div>
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="1" max="200" name="grid_rows" value="{{ $currentGridRows }}" class="form-control" data-rpcppe-print-setting="grid_rows">
                    </div>
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="0" max="200" name="last_page_grid_rows" value="{{ $currentLastPageGridRows }}" class="form-control" data-rpcppe-print-setting="last_page_grid_rows">
                    </div>
                    <div class="core-print-sidebar__field">
                        ...
                        <input type="number" min="10" max="300" name="description_chars_per_line" value="{{ $currentDescriptionCharsPerLine }}" class="form-control" data-rpcppe-print-setting="description_chars_per_line">
                    </div>
                </div>

                <button type="button" class="core-print-sidebar__link-button" data-rpcppe-print-apply-defaults="1">Use Selected Paper Defaults</button>
            </div>

            <div class="core-print-sidebar__section">
                <div class="core-print-sidebar__section-title">Report Fields</div>
                <div class="core-print-sidebar__field">
                    <label class="form-label" for="rpcppe-fund-source">Fund Source</label>
                    <select id="rpcppe-fund-source" name="fund_source_id" class="form-control">
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-office">Office</label>
                        <select id="rpcppe-office" name="department_id" class="form-control">
                    ...
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-filter-officer">Accountable Officer</label>
                        <select id="rpcppe-filter-officer" name="accountable_officer_id" class="form-control" data-rpcppe-print-accountable-filter="1">
                            <option value="">All Accountable Officers</option>
                            @foreach($availableAccountableOfficers as $officer)
                                <option
                                    value="{{ $officer['id'] }}"
                                    data-officer-name="{{ $officer['full_name'] ?? '' }}"
                                    data-officer-designation="{{ $officer['designation'] ?? '' }}"
                                    @selected((string) ($officer['id'] ?? '') === (string) ($document['accountable_officer_id'] ?? ''))
                                >{{ $officer['label'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-as-of">As of Date</label>
                        <input id="rpcppe-as-of" type="date" name="as_of" value="{{ $document['as_of'] ?? '' }}" class="form-control">
                    </div>
                    <div class="core-print-sidebar__field">
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-accountable-name">Accountable Signatory</label>
                        <input
                            id="rpcppe-accountable-name"
                            type="text"
                            name="accountable_officer_name"
                            value="{{ $signatories['accountable_officer_name'] ?? '' }}"
                            class="form-control"
                            autocomplete="off"
                            data-rpcppe-print-accountable-name="1"
                        >
                        <p class="core-print-sidebar__note">Choose an existing accountable officer to reuse the saved name and designation.</p>
                    </div>
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-accountable-designation">Designation</label>
                        <input
                            id="rpcppe-accountable-designation"
                            type="text"
                ...
                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-chair">Committee Chair</label>
                        <input id="rpcppe-chair" type="text" name="committee_chair_name" value="{{ $signatories['committee_chair_name'] ?? '' }}" class="form-control">
                    </div>
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-member-1">Committee Member 1</label>
                        <input id="rpcppe-member-1" type="text" name="committee_member_1_name" value="{{ $signatories['committee_member_1_name'] ?? '' }}" class="form-control">
                    </div>
                </div>

                <div class="core-print-sidebar__field">
                    <label class="form-label" for="rpcppe-member-2">Committee Member 2</label>
                    <input id="rpcppe-member-2" type="text" name="committee_member_2_name" value="{{ $signatories['committee_member_2_name'] ?? '' }}" class="form-control">
                </div>

                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-approved-name">Approved By</label>
                        <input id="rpcppe-approved-name" type="text" name="approved_by_name" value="{{ $signatories['approved_by_name'] ?? '' }}" class="form-control">
                    </div>
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-approved-designation">Approved Designation</label>
                        <input id="rpcppe-approved-designation" type="text" name="approved_by_designation" value="{{ $signatories['approved_by_designation'] ?? '' }}" class="form-control">
                    </div>
                </div>

                <div class="core-print-sidebar__field-grid">
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-verified-name">Verified By</label>
                        <input id="rpcppe-verified-name" type="text" name="verified_by_name" value="{{ $signatories['verified_by_name'] ?? '' }}" class="form-control">
                    </div>
                    <div class="core-print-sidebar__field">
                        <label class="form-label" for="rpcppe-verified-designation">Verified Designation</label>
                        <input id="rpcppe-verified-designation" type="text" name="verified_by_designation" value="{{ $signatories['verified_by_designation'] ?? '' }}" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="core-print-sidebar__section">
                ...
                <div class="core-print-sidebar__stats">
                    ...
                    <div class="core-print-sidebar__stat"><span class="core-print-sidebar__stat-label">PPE Items</span><strong class="core-print-sidebar__stat-value">{{ number_format((int) ($summary['total_items'] ?? 0)) }}</strong></div>
            ...
            <div class="core-print-sidebar__section core-print-sidebar__section--actions">
                ...
                <div class="core-print-sidebar__actions">
                    ...
                    <a href="{{ route('gso.reports.rpcppe.print.pdf', $pdfParams) }}" data-rpcppe-print-pdf-download="1" data-rpcppe-print-pdf-base="{{ route('gso.reports.rpcppe.print.pdf') }}" class="ti-btn btn-wave ti-btn-outline-primary label-ti-btn w-full text-center">
                        <i class="ri-file-pdf-line label-ti-btn-icon me-2"></i>
                        Download PDF
                    </a>
                    <a href="{{ route('gso.reports.rpcppe.print') }}" class="core-print-sidebar__reset">Reset</a>
                </div>
            </div>
        </form>
    </div>
