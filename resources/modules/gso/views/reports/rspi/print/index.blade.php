...
@php
    ...
    $pdfPreviewUrl = route('gso.reports.rspi.print.pdf', array_merge($filters ?? [], ['inline' => 1]))
...
@section('content')
    ...
    <div class="print-workspace-body print-workspace-body--embedded">
        ...
        >
            <x-slot:sidebar>
                @include('gso::reports.rspi.print.partials.controls', [
                    'report' => $report,
                    'paperProfile' => $paperProfile,
...
@push('scripts')
    @vite('resources/modules/gso/js/reports/rspi-print.js')
@endpush
