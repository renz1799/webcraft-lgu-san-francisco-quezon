...
@section('content')
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Job Search</h3>
                            </div>
                                        ...
                                        <div class="box-body p-3">
                                            <div class="grid grid-cols-12 items-center">
                                                <div class="lg:col-span-8 col-span-12">
                                                    <div class="flex">
                                                        <h5 class="font-semibold mb-0"><span class="font-normal">Showing</span> 3456 Jobs</h5>
                                                    </div>
                                                </div>
                                                <div class="lg:col-span-4 col-span-12 text-end">
                                                    <div class="btn-group hs-dropdown ti-dropdown">
                                                        <button class="ti-btn  btn-wave ti-btn-light border dark:border-defaultborder/10 dropdown-toggle" type="button" aria-expanded="false">
                                                            Sort By<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                                        </button>
                                                        <ul class="hs-dropdown-menu ti-dropdown-menu hidden !text-end">
                                                            <li><a class="ti-dropdown-item !text-start" href="javascript:void(0);">Featured</a></li>
                                                            <li><a class="ti-dropdown-item !text-start" href="javascript:void(0);">Newest</a></li>
                                                            <li><a class="ti-dropdown-item !text-start" href="javascript:void(0);">Most Relevant</a></li>
                                                            <li><a class="ti-dropdown-item !text-start" href="javascript:void(0);">Best Rated</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="xxl:col-span-3 lg:col-span-5 col-span-12">
                                        ...
                                        <div class="box-body !p-0">
                                            <div class="p-6 border-b dark:border-defaultborder/10">
                                                ...
                                                <div class="px-2 py-4 pb-0">
                                                    <div class="form-check !mb-2 font-medium">
                                                        <input class="form-check-input" type="checkbox" value="" id="c-1" checked>
                                                        <label class="form-check-label" for="c-1">
                                                            R &amp; D
                                                        </label>
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">2,712</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">536</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">18,289</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">3,453</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">7,165</span>
                                                    </div>
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10">
                                                ...
                                                <div class="px-2 py-3 pb-0">
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">512</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">2,186</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">734</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">16</span>
                                                    </div>
                                                    <div class="form-check">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">1,432</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-4 border-b dark:border-defaultborder/10">
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10">
                                                ...
                                                <div class="px-2 py-3 pb-0">
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">16,563</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">15,234</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">6,278</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">4,531</span>
                                                    </div>
                                                    <div class="form-check">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">2,405</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-4 border-b dark:border-defaultborder/10">
                                                ...
                                                <div class="px-2 py-3 pb-0">
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">23,156</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">15,632</span>
                                                    </div>
                                                    <div class="form-check !mb-2 font-medium">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">15,032</span>
                                                    </div>
                                                    <div class="form-check">
                                                        ...
                                                        <span class="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">7,154</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-4">
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="">
                                                <h5 class="font-semibold mb-4">Get Latest Job Alerts</h5>
                                                ...
                                                <div class="input-group mb-4">
                                                    <input type="text" class="form-control !border-s" placeholder="Email Here" aria-label="blog-email" aria-describedby="blog-subscribe">
                                                    <button class="ti-btn  btn-wave ti-btn-primary-full !mb-0" type="button" id="blog-subscribe">Subscribe</button>
                                                </div>
                                    ...
                                    <div class="box custom-box featured-jobs">
                                        <div class="box-body">
                                            ...
                                            <div class="popular-tags mb-4">
                                                ...
                                                <a href="javascript:void(0);" class="badge !rounded-full bg-light !text-defaulttextcolor"><i class="bi bi-briefcase text-muted me-1"></i> 13 Openings</a>
                                                ...
                                                <a href="javascript:void(0);" class="badge !rounded-full bg-light !text-defaulttextcolor"><i class="bi bi-moon-stars text-muted me-1"></i> flexible-shift</a>
                                            </div>
                                            <div class="flex justify-between">
                                                <h6 class="font-semibold mb-0">$25,000 - $35,000</h6>
                                                <a href="" class="text-primary font-semibold text-[.875rem] inline-flex items-center">
                                    ...
                                    <div class="box custom-box featured-jobs">
                                        <div class="box-body">
                                            ...
                                            <div class="flex mb-4 flex-wrap gap-2 items-center">
                                                ...
                                                <div>
                                                    <h5 class="font-semibold mb-0 flex items-center"><a href="javascript:void(0);"> React Lead Developer</a></h5>
                                    ...
                                    <div class="box custom-box featured-jobs">
                                        <div class="box-body">
                                            ...
                                            <div class="flex mb-4 flex-wrap gap-2 items-center">
                                                ...
                                                <div>
                                                    <h5 class="font-semibold mb-0 flex items-center"><a href="javascript:void(0);"> Vuejs Frontend Developer</a></h5>
                                    ...
                                    <div class="box custom-box featured-jobs">
                                        <div class="box-body">
                                            ...
                                            <div class="flex mb-4 flex-wrap gap-2 items-center">
                                                ...
                                                <div>
                                                    <h5 class="font-semibold mb-0 flex items-center"><a href="javascript:void(0);"> Wordpress Developer - Remote</a></h5>
