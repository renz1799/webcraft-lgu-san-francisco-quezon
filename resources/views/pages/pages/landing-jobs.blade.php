...
@section('content')
                                        ...
                                        <div class="">
                                            ...
                                            <div class="mb-4 custom-form-group ">
                                                ...
                                                <div class="custom-form-btn">
                                                    ...
                                                    <button class="ti-btn btn-wave bg-primary text-white   !font-medium !border dark:border-defaultborder/10-0" type="button"><i class="bi bi-search me-2"></i> Search</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Start:: Section-2 -->
                    <section class="section section-bg dark:!bg-black/10 text-defaulttextcolor" id="jobs">
                        <div class="container">
                            <div class="flex items-center justify-between flex-wrap gap-4 mb-[3rem]">
                                <div>
                                    <p class="text-[0.75rem] font-semibold mb-1">Find jobs</p>
                                    <h3 class="font-semibold mb-0 dark:text-defaulttextcolor/70">Browse Jobs by Top Categories</h3>
                                    <span class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] font-normal block">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</span>
                                </div>
                                <div>
                                    <a href="javascript:void(0);" class="ti-btn btn-wave bg-primary text-white !font-medium">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="lg:col-span-4 md:col-span-6 col-span-12">
                                    <div class="box border dark:border-defaultborder/10">
                            ...
                            <div class="grid grid-cols-12 gap-6 items-center justify-center">
                                ...
                                <div class="md:col-span-7 xl:col-span-8 col-span-12">
                                    <div class="my-6">
                                        ...
                                        <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-light ti-btn-lg dark:border-defaultborder/10 !font-medium"><i class="ti ti-upload"></i> Upload Your Resume</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class=" justify-center text-center mb-[3rem]">
                                <div class="xl:col-span-6 col-span-12">
                                    ...
                                    <h3 class="font-semibold mb-2 dark:text-defaulttextcolor/70">Featured Jobs</h3>
                                    <span class="text-[#8c9097] dark:text-white/50 text-[0.9375rem] font-normal block">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</span>
                                </div>
                            </div>
                                    ...
                                    <div class="box featured-jobs">
                                        <div class="box-body">
                                            ...
                                            <div class="popular-tags mb-4">
                                                <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default"><i class="bi bi-geo-alt text-[#8c9097] dark:text-white/50 me-1"></i> Hyderabad</a>
                                                <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default"><i class="bi bi-briefcase text-[#8c9097] dark:text-white/50 me-1"></i> 13 Openings</a>
                                                <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default"><i class="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</a>
                                                <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default"><i class="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Min - 2Years</a>
                                                <a href="javascript:void(0);" class="badge rounded-pill bg-light text-default"><i class="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</a>
                                            </div>
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">
                    ...
                    <section class="section bg-primary">
                        <div class="container">
                            <div class="grid grid-cols-12 justify-center text-center mb-[3rem] text-white">
                                ...
                                <div class="xl:col-span-6 col-span-12">
                                    <h3 class="font-semibold mb-2 dark:text-defaulttextcolor/70">Which Type Of Job You Want ?</h3>
                                ...
                                <div class="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                                    <div class="box feature-style">
                                        <div class="box-body">
                                            ...
                                            <p class="text-[#8c9097] dark:text-white/50 mb-4">120 Jobs Available</p>
                                            <a class="text-primary font-semibold" href="javascript:void(0);">Explore Jobs<i class="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="grid grid-cols-12 items-center justify-center">
                                ...
                                <div class="md:col-span-8 col-span-12 my-6">
                                    <h2 class="font-semibold mb-4 text-[2rem] dark:text-defaulttextcolor/70">Are You Looking For A best Candidate? <br> Just <a href="javascript:void(0);" class="text-primary text-decoration-line"> <u>Publish</u> </a> your job here..</h2>
                                    <span class="mb-6 text-[0.9375rem] font-normal text-[#8c9097] dark:text-white/50 block">Est amet sit vero sanctus labore no sed nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum.Est amet sit vero sanctus labore no sed ipsum ipsum nonumy vero sanctus labore.. </span>
                                    <a href="javascript:void(0);" class="ti-btn btn-wave bg-primary text-white dark:border-defaultborder/10 !font-medium ti-btn-lg"><i class="ti ti-upload"></i> Publish new job</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <!-- Start:: Section-8 -->
                    <section class="section text-defaulttextcolor text-defaultsize" id="blogs">
                        <div class="container">
                            <div class=" mb-[3rem] justify-center text-center">
                                ...
                                <h3 class="font-semibold mb-2 text-[1.75rem] dark:text-defaulttextcolor/70">Latest News Updates &amp; Blogs</h3>
                                <div class="xl:col-span-9 col-span-12">
                                    <span class="block font-normal text-[0.9375rem] text-[#8c9097] dark:text-white/50">Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</span>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-3 col-span-12 text-end my-auto">
                                    <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-lg ti-btn-danger-full">Upload Your Resume</a>
                                </div>
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div class="box text-start featured-card-4">
                                        ...
                                        <div class="box-body p-4">
                                            <div class="flex items-center">
                                                <div class="me-2 p-2 !bg-primary/10 !rounded-full dark:border-defaultborder/10 !border dark:border-defaultborder/10-primary/10">
                                            ...
                                            <div class="box-body p-4">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">MANAGER CHO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-4">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO OF EMPIRO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-6">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CHIEF SECRETARY MBIO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-4">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO ARMEDILLO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-4">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">AGGENT AMIO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-6">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO MR BRAND</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                                            ...
                                            <div class="box-body p-6">
                                                ...
                                                <div class="flex mb-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO AIBMO</p>
                                                    </div>
                                                </div>
                                                <span>- Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labor</span>
                                            </div>
                    ...
                    <section class="section bg-banner" id="career-advice">
                        <div class="grid grid-cols-12 justify-center !px-4">
                            ...
                            <div class="lg:col-span-6 col-span-12 text-center">
                                ...
                                <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-lg ti-btn-light me-2 dark:border-defaultborder/10 !font-medium"><i class="bi bi-search me-1"></i> Search Jobs</a>
                                <a href="javascript:void(0);" class="ti-btn btn-wave ti-btn-lg  ti-btn-danger-full text-white  !font-medium"><i class="bi bi-send me-1"></i> Apply Job Now</a>
                            </div>
                            <div class="lg:col-span-3 col-span-12"></div>
                        </div>
                    </section>
