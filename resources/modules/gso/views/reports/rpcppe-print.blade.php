...
<head>
  ...
  <title>RPCPPE - {{ $report['as_of_label'] ?? 'Report' }}</title>
...
>
  <x-slot:sidebar>
    <x-print.panel
      ...
      copy="Set the cutoff, office scope, and signatories here, then review the printable property count report on the right."
    >
      ...
      <form method="GET" action="{{ route('gso.inventory-items.rpcppe.print') }}" class="gso-report-filter-form">
        ...
        <div class="gso-report-filter-group">
          <label for="rpcppe-fund-source">Fund Source</label>
          <select id="rpcppe-fund-source" name="fund_source_id">
        ...
        <div class="gso-report-filter-group">
          <label for="rpcppe-office">Office</label>
          <select id="rpcppe-office" name="department_id">
        ...
        <div class="gso-report-filter-group">
          <label for="rpcppe-officer">Accountable Officer</label>
          <select id="rpcppe-officer" name="accountable_officer_id">
        ...
        <div class="gso-report-filter-group">
          <label for="rpcppe-as-of">As of Date</label>
          <input id="rpcppe-as-of" type="date" name="as_of" value="{{ $report['as_of'] ?? '' }}">
        </div>
        ...
        <div class="gso-report-filter-group">
          <label for="rpcppe-accountable-name">Accountable Officer Signatory</label>
          <input id="rpcppe-accountable-name" type="text" name="accountable_officer_name" value="{{ $signatories['accountable_officer_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-accountable-designation">Accountable Designation</label>
          <input id="rpcppe-accountable-designation" type="text" name="accountable_officer_designation" value="{{ $signatories['accountable_officer_designation'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-chair">Inventory Committee Chair</label>
          <input id="rpcppe-chair" type="text" name="committee_chair_name" value="{{ $signatories['committee_chair_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-member-1">Committee Member 1</label>
          <input id="rpcppe-member-1" type="text" name="committee_member_1_name" value="{{ $signatories['committee_member_1_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-member-2">Committee Member 2</label>
          <input id="rpcppe-member-2" type="text" name="committee_member_2_name" value="{{ $signatories['committee_member_2_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-approved-name">Approved By</label>
          <input id="rpcppe-approved-name" type="text" name="approved_by_name" value="{{ $signatories['approved_by_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-approved-designation">Approved Designation</label>
          <input id="rpcppe-approved-designation" type="text" name="approved_by_designation" value="{{ $signatories['approved_by_designation'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-verified-name">Verified By</label>
          <input id="rpcppe-verified-name" type="text" name="verified_by_name" value="{{ $signatories['verified_by_name'] ?? '' }}">
        </div>

        <div class="gso-report-filter-group">
          <label for="rpcppe-verified-designation">Verified Designation</label>
          <input id="rpcppe-verified-designation" type="text" name="verified_by_designation" value="{{ $signatories['verified_by_designation'] ?? '' }}">
        </div>
  ...
  @foreach($pages as $pageIndex => $pageRows)
    ...
    <div class="gso-report-page print-page">
      <div class="gso-report-content">
        <div class="gso-report-appendix">{{ $report['appendix_label'] ?? 'RPCPPE' }}</div>
        <div class="gso-report-title">Report on the Physical Count of Property, Plant and Equipment</div>
        ...
        <table class="gso-report-items-table">
          ...
          <tbody>
            @if($pageRows->isEmpty())
              <tr><td colspan="10" class="gso-report-empty-note">No PPE balances found for the selected report window.</td></tr>
