...
@php
    ...
    $pdfPreviewUrl = route('gso.reports.rpcsp.print.pdf', array_merge($filters ?? [], ['inline' => 1]))
...
@section('content')
    ...
    <div class="print-workspace-body print-workspace-body--embedded">
        ...
        >
            <x-slot:sidebar>
                @include('gso::reports.rpcsp.print.partials.controls', [
                    'report' => $report,
                    'paperProfile' => $paperProfile,
...
@push('scripts')
    @vite('resources/modules/gso/js/reports/rpcsp-print.js')
@endpush
