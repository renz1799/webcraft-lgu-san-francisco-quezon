                                                      ...
                                                      <div class="table-responsive">
                                                          <table class="table table-bordered whitespace-nowrap min-w-full">
                                                              <tbody>
                                                                  ...
                                                                  <tr>
                                                                      <td class="grid">
                                                                          <button type="button" class="ti-btn btn-wave ti-btn-primary !font-medium">View All Products</button>
                                                                      </td>
                                                                  </tr>
                                                              </tbody>
                                                          </table>
                                                  ...
                                                  <div class="xl:col-span-4 col-span-12 xxl:mt-0 mt-6">
                                                      <div class="mb-[3rem]">
                                                              ...
                                                              <ul class="list-group">
                                                                  ...
                                                                  <li class="list-group-item !p-0 hs-collapse hidden w-full overflow-hidden transition-[height] duration-300" id="hs-show-hide-collapse-heading"  aria-labelledby="hs-show-hide-collapse">
                                                                      <ul class="list-group" id="offers-more">
                                                                          ...
                                                                          <li class="list-group-item !border-t !border-b-0 !border-x-0">
                                                                              <div class="text-[0.75rem] text-default">
                                                          ...
                                                          <div class="grid gap-2">
                                                              <a href="{{url('cart')}}" class="ti-btn btn-wave bg-primary !font-medium text-white">Add To Cart</a>
                                                              <a href="{{url('checkout')}}" class="ti-btn btn-wave bg-success !font-medium text-white">Buy Now</a>
