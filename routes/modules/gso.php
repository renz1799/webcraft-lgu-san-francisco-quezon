...
Route::middleware(['auth', 'password.changed'])->group(function () {
    Route::prefix('gso')
        ...
        ->group(function () {
            ...
            Route::post('/ris/{ris}/print/pdf/store', [RisPrintController::class, 'storePdf'])->whereUuid('ris')->name('ris.print.archive');
            Route::get('/ris/{ris}/print/pdf/archive', [RisPrintController::class, 'viewArchivedPdf'])->whereUuid('ris')->name('ris.print.archive.view');
            ...
            Route::post('/pars/{par}/print/pdf/store', [ParPrintController::class, 'storePdf'])->whereUuid('par')->name('pars.print.archive');
            Route::get('/pars/{par}/print/pdf/archive', [ParPrintController::class, 'viewArchivedPdf'])->whereUuid('par')->name('pars.print.archive.view');
            ...
            Route::post('/ics/{ics}/print/pdf/store', [IcsPrintController::class, 'storePdf'])->whereUuid('ics')->name('ics.print.archive');
            Route::get('/ics/{ics}/print/pdf/archive', [IcsPrintController::class, 'viewArchivedPdf'])->whereUuid('ics')->name('ics.print.archive.view');
            ...
            Route::post('/ptrs/{ptr}/print/pdf/store', [PtrPrintController::class, 'storePdf'])->whereUuid('ptr')->name('ptrs.print.archive');
            Route::get('/ptrs/{ptr}/print/pdf/archive', [PtrPrintController::class, 'viewArchivedPdf'])->whereUuid('ptr')->name('ptrs.print.archive.view');
            ...
            Route::post('/itrs/{itr}/print/pdf/store', [ItrPrintController::class, 'storePdf'])->whereUuid('itr')->name('itrs.print.archive');
            Route::get('/itrs/{itr}/print/pdf/archive', [ItrPrintController::class, 'viewArchivedPdf'])->whereUuid('itr')->name('itrs.print.archive.view');
            ...
            Route::post('/wmrs/{wmr}/print/pdf/store', [WmrPrintController::class, 'storePdf'])->whereUuid('wmr')->name('wmrs.print.archive');
            Route::get('/wmrs/{wmr}/print/pdf/archive', [WmrPrintController::class, 'viewArchivedPdf'])->whereUuid('wmr')->name('wmrs.print.archive.view');
            ...
            Route::post('/air/{air}/print/pdf/store', [AirPrintController::class, 'storePdf'])->whereUuid('air')->name('air.print.archive');
            Route::get('/air/{air}/print/pdf/archive', [AirPrintController::class, 'viewArchivedPdf'])->whereUuid('air')->name('air.print.archive.view');
