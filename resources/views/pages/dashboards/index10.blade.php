                                    ...
                                    <div class="md:flex block flex-wrap items-center justify-between">
                                        <div class="flex-grow">
                                            <nav class="nav nav-pills nav-style-3 flex md:mb-0 mb-4" aria-label="Tabs" role="tablist">
                                                <a class="nav-link text-defaulttextcolor !py-[0.35rem] !px-4 text-sm !font-medium text-center rounded-md hover:text-primary cursor-pointer active" id="portfolio-item" data-hs-tab="#Stocksportfolio" aria-controls="Stocksportfolio">
                                                    Portfolio
                                                </a>
                                                <a class="nav-link text-defaulttextcolor !py-[0.35rem] !px-4 text-sm !font-medium text-center rounded-md hover:text-primary cursor-pointer" id="market-item" data-hs-tab="#Stocksmarket" aria-controls="Stocksmarket">
                                                    Market
                                                </a>
                                            </nav>
                                        </div>
                                                ...
                                                <div class="box-header justify-between">
                                                    ...
                                                    <div class="flex items-center flex-wrap gap-2">
                                                        ...
                                                        <div class="hs-dropdown ti-dropdown !py-0 !mt-0 !mb-0">
                                                            ...
                                                            class="ti-btn btn-wave ti-btn-primary !py-1 !px-2 !text-[0.75rem] !m-0 !gap-0 !font-medium !mb-0"
                                                            aria-expanded="false">
                                                    ...
                                                    <ul class="list-none my-stocks-ul mb-0">
                                                        ...
                                                        <li>
                                                            <div class="flex items-center flex-grow leading-none">
                                                                <div class="me-2">
                                                                    <span class="avatar avatar-rounded bg-light p-2 !mb-0">
                                                                        <i class="bi bi-twitter-x text-info text-[1.125rem]"></i>
                                                                    </span>
                                                                </div>
                                                                <div class="leading-none flex-grow">
                                                ...
                                                <div class="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                                    <div class="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                                                        ...
                                                        <div class="flex gap-2">
                                                            <button type="button" class="ti-btn btn-wave ti-btn-sm ti-btn-light flex-grow font-medium">Short</button>
                                                            <button type="button" class="ti-btn btn-wave ti-btn-sm ti-btn-primary flex-grow font-medium">Buy</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                                                    ...
                                                                    <div class="grid grid-cols-12 sm:gap-x-6">
                                                                        ...
                                                                        <div class="xl:col-span-6  col-span-12">
                                                                            ...
                                                                            <div class="flex gap-3">
                                                                                <button type="button" class="flex-grow ti-btn btn-wave ti-btn-sm bg-primary text-white">Buy</button>
                                                                                <button type="button" class="flex-grow ti-btn btn-wave ti-btn-sm bg-secondary text-white">Sell</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
