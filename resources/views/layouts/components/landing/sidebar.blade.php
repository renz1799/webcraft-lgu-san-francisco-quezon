                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <div class="responsive-logo">
                            <a class="responsive-logo-light" href="{{url('index')}}" aria-label="Brand"><img
                                src="{{asset('build/assets/images/brand-logos/desktop-logo.png')}}" alt="logo" class="mx-auto"></a>
                            <a class="responsive-logo-dark" href="{{url('index')}}" aria-label="Brand"><img
                                src="{{asset('build/assets/images/brand-logos/desktop-white.png')}}" alt="logo" class="mx-auto"></a>
                        </div>
                        </div>
                        ...
                        <a href="{{url('signup-basic')}}" class="ti-btn btn-wave w-[6.375rem] ti-btn-primary-full m-0 p-2">Sign
                            Up</a>
                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn btn-wave m-0 p-2 px-3 ti-btn-light !font-medium"
